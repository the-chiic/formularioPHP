<?php
    ...
    require_once "funcionesFormulario.php";

    $objFuncionesFormulario=new funcionesFormulario();
    $paises=$objFuncionesFormulario->mostrarPaises();
    $contactos=$objFuncionesFormulario->mostrarContactos();
...
<html lang="es">
    ...
    <body>
        ...
        <form action="versionRecogerTodo.php" method="post">
